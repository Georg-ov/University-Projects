...
# Topics para Oficina 1
TOPIC_TEMP_SENSOR = "/topic/sensor/temperatura/oficina1"
TOPIC_LUZ_SENSOR = "/topic/sensor/luz/oficina1"
TOPIC_TEMP_ACTUADOR = "/topic/actuador/temperatura/oficina1"
TOPIC_LUZ_ACTUADOR = "/topic/actuador/luz/oficina1"
...
async def main():
    ...
    conn.connect("oficina1", "oficina1", wait=True) #Autenticacion

    # Suscribirse a los topics de actuadores de Oficina 1
