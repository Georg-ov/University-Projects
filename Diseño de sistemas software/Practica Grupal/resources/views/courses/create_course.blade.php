    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-xl-10">
            <div class="card rounded-3 text-black" style="background-color: #282C2F;">
                <form method="POST" action="{{ route('course.create.save') }}" enctype="multipart/form-data">
                    <div class="row g-0">
                        @csrf
                        <div class="col-lg-8">
                            <div class="card-body p-md-3 mx-md-4">
                                <h3 class="text-title">Create a Course</h3>
                                ...
                                <div class="form-floating mb-3 custom-input">
                                    <select class="form-select text-label" name="visibility" id="visibility" required>
                                        ...
                                        <option value="0" selected class="select-option">Private</option>
                                    </select>
                                ...
                                <div class="form-floating mb-3 custom-input">
                                    <select class="form-select text-label" name="is_free" id="is_free" required>
                                        <option value="1" class="select-option">Free</option>
                                        <option value="0" class="select-option">Premium</option>
                                    </select>
                        ...
                        <div class="col-lg-4 custom-column">
                            ...
                            <div class="mb-3 custom-input">
                                ...
                                <input type="file" class="form-control text-label" id="image_file_name" name="image_file_name" accept="image/*" required>
                            </div>
                        </div>
                    </div>
                    <div class="row g-1 custom-row">
                        <button type="submit" class="btn btn-darkbtn-block fa-lg gradient-custom-2 mb-3" style="width: 100%; border-color: #6AA7B9; font-family: 'Orbitron', sans-serif; width: 90%;">Create Course</button>
                    </div>
                </form>
            </div>
        </div>
