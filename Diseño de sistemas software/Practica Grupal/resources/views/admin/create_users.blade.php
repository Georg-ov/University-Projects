...
<div style="padding-top: 20px; padding-left: 5px;">
    <p class="font-weight-bold h2 mx-auto" style="font-family: 'Orbitron', sans-serif; color: #e93578; font-size: 26px;"> Create New User </p>
</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                        <div class="text-sm-left mb-2 mb-sm-0">
                                            <h4 class="pt-sm-2 pb-1 mb-0 text-nowrap" style="font-family: 'Noto Serif Lao', serif;"></h4>
                                            <p class="mb-0" style="font-family: 'Noto Serif Lao', serif;"></p>
                                            <div class="text-muted" style="font-family: 'Noto Serif Lao', serif;"><small></small>
                                            </div>
                                            <div class="mt-2">
                                    ...
                                    <div class="tab-pane active">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="text" name="name" style="font-family: 'Noto Serif Lao', serif; font-size: 14px;" value="{{ old('name') }}">
                                                                @error('name')
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="text" name="username" style="font-family: 'Noto Serif Lao', serif; font-size: 14px;" value="{{ old('username') }}">
                                                                @error('username')
                                                                    <div class="alert alert-danger alert-white rounded">
                                                                        <button type="button" data-bs-dismiss="alert" aria-hidden="true" class="btn-close"></button>
                                                                        <div class="icon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group" style="padding-top: 10px;">
                                                                ...
                                                                <input class="form-control" type="text" name="email" placeholder="" value="{{ old('email') }}" style="font-family: 'Noto Serif Lao', serif; font-size: 14px;">
                                                                @error('email')
                                                                    <div class="alert alert-danger alert-white rounded">
                                                                        <button type="button" data-bs-dismiss="alert" aria-hidden="true" class="btn-close"></button>
                                                                        <div class="icon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group" style="padding-top: 10px;">
                                                                <label style="font-family: 'Noto Serif Lao', serif; font-size: 14px;">Birthday</label>
                                                                <input class="form-control" type="date" name="birthday" style="font-family: 'Noto Serif Lao', serif; font-size: 14px;" value="{{ old('birthday') }}">
                                                                @error('birthday')
                                                                    <div class="alert alert-danger alert-white rounded">
                                                                        <button type="button" data-bs-dismiss="alert" aria-hidden="true" class="btn-close"></button>
                                                                        <div class="icon">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6 mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group" style="padding-top: 10px;">
                                                                <label style="font-family: 'Noto Serif Lao', serif; font-size: 14px;">Password</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group" style="padding-top: 10px;">
                                                                <label style="font-family: 'Noto Serif Lao', serif; font-size: 14px;">Repeat Password</label>
                                            ...
                                            <div class="row">
                                                <div class="col d-flex justify-content-end">
                                                    <a href="http://127.0.0.1:8000/admin/users" style="font-family: 'Noto Serif Lao', serif; font-size: 14px; color: #e93578; padding-right: 9px; padding-top: 7px;">Back</a>
                                                    <button class="btn btn-update" type="submit" style="font-family: 'Noto Serif Lao', serif; font-size: 14px;">Save User</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
